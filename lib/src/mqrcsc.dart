...
import 'package:ai_barcode_scanner/src/mgbv.dart';
...
class MQRCSC extends StatefulWidget {
  ...
  const MQRCSC({
    ...
    this.cameraSwitchIcon = Icons.change_circle,
  ...
  @override
  State<MQRCSC> createState() => _MQRCSCState();
}

class _MQRCSCState extends State<MQRCSC> {
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Icon(
                      isTorchOn ? widget.flashOnIcon : widget.flashOffIcon,
                      size: 40,
                      color: Colors.white,
                    ),
                  ),
